...
/****** Object:  View [dbo].[ApplicantInfoModel]    Script Date: 11/20/2019 8:48:54 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[ApplicantInfoModel]
AS
...
Begin DesignProperties = 
   ...
   End
End
' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ApplicantInfoModel'
GO

EXEC sys.sp_addextendedproperty @name=N'MS_DiagramPaneCount', @value=1 , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'VIEW',@level1name=N'ApplicantInfoModel'
GO
