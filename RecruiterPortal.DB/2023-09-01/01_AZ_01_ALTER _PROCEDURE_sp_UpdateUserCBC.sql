...
GO
/****** Object:  StoredProcedure [dbo].[sp_UpdateUserCBC]    Script Date: 9/1/2023 2:32:54 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER   PROCEDURE [dbo].[sp_UpdateUserCBC]
(		    @p_CBCID  bigint
	       ,@p_UserID  bigint	
           ,@p_AliasAKA nvarchar (500)
           ,@p_HomePhone nvarchar (500)
           ,@p_AgencyIdentification nvarchar (500)
           ,@p_LTHHPPFI nvarchar (500)
           ,@p_LHCSALicense nvarchar (500)
...
UPDATE [dbo].[CBCForm]
   SET [UserID] = @p_UserID
      ,[Alias_AKA] = @p_AliasAKA
      ,[HomePhone] = @p_HomePhone
      ,[AgencyIdentification] = @p_AgencyIdentification
      ,[LTHHP_PFI] = @p_LTHHPPFI
      ,[LHCSA_License] = @p_LHCSALicense
