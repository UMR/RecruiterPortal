...
GO
/****** Object:  StoredProcedure [dbo].[sp_UpdateNurseForm]    Script Date: 06/17/2022 3:41:16 PM ******/
SET ANSI_NULLS ON
GO
...
ALTER   PROCEDURE [dbo].[sp_UpdateNurseForm]
(
	@ApplyingForJobType bit NULL,
	@ApplyingForPosition TINYINT NULL,
...
UPDATE [dbo].[NurseForm]
    SET [ApplyingForJobType] = @ApplyingForJobType
	  ,[ApplyingForPosition] = @ApplyingForPosition
	  ,[LicensedJurisdiction] = @LicensedJurisdiction
