...
export class EmergencyInfoService {
    ...
    getEmergencyInfoByApplicantId(applicantId: number): Observable<HttpResponse<any>> {
        return this.httpClient.get(`${this.getEmergencyInfoURI}/${applicantId}`, { observe: 'response' });
    }
