...
export class UploadRequirementsService {
  ...
  updateEmpolymentClass(empClass: any): Observable<HttpResponse<any>> {
    return this.http.get(this.updateEmpClass + empClass, { observe: 'response' });
  }

  getEmpolymentClass(): Observable<HttpResponse<any>> {
    return this.http.get(this.getEmpClass, { observe: 'response' });
  }
