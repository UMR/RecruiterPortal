...
export class AddEditUscisComponent implements OnInit {
    ...
    fillUpUSCISInfo() {
        this.addEditUSCISGroup.setValue({
            ...
            zipCode: { ZipCode: this.checkNullOrUndefined(this.userUSCIS.ZipCode) },
    ...
    onSubmit() {
        if (!this.userUSCISId && this.isEmpty()) {
            ...
            const model: any = {
                ...
                zipCode: this.addEditUSCISGroup.get('zipCode').value ? this.addEditUSCISGroup.get('zipCode').value.ZipCode : "",
